...
export default function page() {
  ...
  return (
    <div className="w-1024 h-screen bg-[url(/bg/bg6-20.webp)] bg-[length:450px_900px] bg-center">
      <div className="absolute top-[2%] left-[19%] grid w-[252px] justify-items-center">
        <div
      ...
      >
        <div className="absolute right-[16%] top-[8%] flex h-11 w-11 items-center justify-center gap-2.5 ">
          <DownloadIcon />
        </div>
